        ...
        <div className="w-full flex flex-col lg:flex-row gap-8">
              ...
              <Range
                ...
                renderTrack={({ props, children }) => {
                  ...
                  return (
                    <div
                      {...props}
                      className="relative h-[6px] rounded-full bg-orange-100"
                      style={{ ...props.style }}
                    >
                      <div
                        className="absolute h-full rounded-full bg-gradient-to-r from-orange-400 to-orange-600"
                        style={{
                          left: `${percentageLeft}%`,
                ...
                renderThumb={({ props }) => {
                  ...
                  return (
                    <div
                      key={key}
                      {...rest}
                      className="group h-[18px] w-[18px] rounded-full bg-white border-2 border-orange-500 shadow-md transition hover:scale-110 focus:outline-none"
                    >
                      {/* inner dot */}
          ...
          <div className="flex-1 px-2 lg:px-3">
            {isProductLoading ? (
              ...
              <div className="flex flex-col items-center justify-center py-10 px-6 rounded-xl border border-gray-200 bg-white shadow-sm">
